...
<form action="/search/redirect" method="get">
  <div class="bg-white px-5 py-3">
    <div class="flex">
      ...
      <h2
        class="font-bold text-brand-600 text-lg flex-1"
      >
        Check Prices
      </h2>
      <!-- 
        ...
        <div class="grid grid-cols-1 gap-5 md:grid-cols-3 md:gap-0">
          ...
          <div class="col-span-2 md:col-span-1">
            <div class="grid grid-cols-1 md:grid-cols-2">
              ...
              <!-- <InputNumber name="pax" label="Passengers" class="w-full" bind:value={search.pax} hideSteppers={innerWidth < 480 ? true : false} /> -->
            </div>
          </div>
        </div>
