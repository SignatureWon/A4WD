        ...
        <div class="flex-1">
          <div class="md:flex">
            <div class="md:flex-1">
              <Select
                labelText="Depot"
                selected={row.Depots.id}
                class="mb-5"
                on:change={(e) => {
                  let selected = depots.filter(function (record) {
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <TextInput
                  labelText="Contact (International)"
                  bind:value={row["Contact (International)"]}
                />
                <TextInput
                  labelText="Contact (Australia)"
                  bind:value={row["Contact (Australia)"]}
                />
              </div>
            </div>
