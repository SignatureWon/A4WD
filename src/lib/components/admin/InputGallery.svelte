    ...
    <FileUploader
      ...
      on:change={async (files) => {
        ...
        value = [
          ...
          {
            name: filename,
            url: `${env.PUBLIC_SUPABASE_URL}/storage/v1/render/image/public/gallery/${filename}?width=1200&height=1200&resize=contain`,
            thumb: `${env.PUBLIC_SUPABASE_URL}/storage/v1/render/image/public/gallery/${filename}?width=400&height=400&resize=contain`,
            caption: "",
          },
        ];
      }}
