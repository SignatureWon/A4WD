...
<table cellpadding="0" cellspacing="0" role="presentation" width="100%">
  <tr>
    <td style="padding: 0 24px;">
      <table cellpadding="0" cellspacing="0" role="presentation" width="100%">
        <tr>
            <td class="col" width="100%" style="padding: 10px; background-color: ${c.brand100}">
      ...
      <table cellpadding="0" cellspacing="0" role="presentation" width="100%">
        <tr>
          ...
          <td class="col" width="184" style="padding: 10px; border-bottom: 1px solid #DDDDDD">
            ...
            <div><b>${
              quote.date_provisional ? dayjs(quote.date_provisional).format("DD MMM YYYY") : "&mdash;"
            }</b></div>
          </td>
          <td class="col" width="184" style="padding: 10px; border-bottom: 1px solid #DDDDDD">
      ...
      <table cellpadding="0" cellspacing="0" role="presentation" width="100%">
        <tr>
            <td class="col" width="100%">
                ...
                The Agent Deposit will be carried forward towards a future booking for next 3 months or further at managers discretion if cancellation is made more than 62 days prior to travel. An additional AUD $200.00 administration cancellation fee applies. Please read the cancellation policy found in the quote.
            </td>
        </tr>
      </table>
    </td>
      ...
      <table cellpadding="0" cellspacing="0" role="presentation" width="100%">
        <tr>
            <td class="col" width="100%" align="center" style="font-size: 11px">
                <p>
                    <a href="https://www.australia4wdrentals.com/files/australia4wheeldriverentals-terms-and-conditions" style="color: ${c.brand500}">
