...
<table cellpadding="0" cellspacing="0" role="presentation" width="100%">
  <tr>
    <td style="padding: 0 24px;">
      <table cellpadding="0" cellspacing="0" role="presentation" width="100%">
        <tr>
          <td class="col" width="184" style="padding: 15px 10px; border-bottom: 1px solid #DDDDDD">
...
<table cellpadding="0" cellspacing="0" role="presentation" width="100%">
  <tr>
    <td style="padding: 0 24px;">
      <table cellpadding="0" cellspacing="0" role="presentation" width="100%">
        <tr>
          <td class="col" width="276" style="padding: 15px 10px; border-bottom: 1px solid #DDDDDD">
...
<table cellpadding="0" cellspacing="0" role="presentation" width="100%">
  <tr>
    <td style="padding: 0 24px;">
      <table cellpadding="0" cellspacing="0" role="presentation" width="100%">
        <tr>
            <td class="col" width="100%" style="padding: 15px 10px; border-bottom: 1px solid #DDDDDD">
...
<table cellpadding="0" cellspacing="0" role="presentation" width="100%">
  <tr>
    ...
    summary.agentItems.forEach((item) => {
      email += `
        <tr>
          <td class="col" width="414" style="padding: 15px 10px; border-bottom: 1px solid #DDDDDD">
            <div>${item.name}</div>
          </td>
          <td class="col" width="138" align="right" style="padding: 15px 10px; border-bottom: 1px solid #DDDDDD">
    ...
    email += `
        <tr>
          <td class="col" width="414" style="padding: 15px 10px; border-bottom: 1px solid #DDDDDD; background-color: ${c.brand100}">
            <div><b>Total payable to agent</b></div>
          </td>
          <td class="col" width="138" align="right" style="padding: 15px 10px; border-bottom: 1px solid #DDDDDD; background-color: ${c.brand100}">
...
<table cellpadding="0" cellspacing="0" role="presentation" width="100%">
  <tr>
    <td style="padding: 0 24px;">
      <table cellpadding="0" cellspacing="0" role="presentation" width="100%">
        <tr>
          <td class="col" width="414" style="padding: 15px 10px; border-bottom: 1px solid #DDDDDD; background-color: ${c.brand500}; color: #FFFFFF">
            <div><b>Total amount</b></div>
          </td>
          <td class="col" width="138" align="right" style="padding: 15px 10px; border-bottom: 1px solid #DDDDDD; background-color: ${c.brand500}; color: #FFFFFF">
      ...
      <table cellpadding="0" cellspacing="0" role="presentation" width="100%">
        <tr>
            <td class="col" width="100%" style="background-color: ${c.brand100}; padding: 15px">
                <p><a href="https://www.australia4wdrentals.com" style="color: #1d4ed8">www.australia4wdrentals.com</a> is protected by a 256-bit ssl for complete peace of mind when booking online.</p>
                <br>
  ...
  <tr>
    <td style="padding: 0 24px;">
      <table cellpadding="0" cellspacing="0" role="presentation" width="100%">
        <tr>
            <td class="col" width="100%">
                <div style="font-size: 16px"><b>Alternative payment options</b></div>
                <p>
      ...
      <table cellpadding="0" cellspacing="0" role="presentation" width="100%">
        <tr>
            <td class="col" width="100%" align="center" style="background-color: #e9f7e8; padding: 15px">
                ...
                <p>
                    <b><a href="https://www.australia4wdrentals.com" style="color: #1d4ed8">
