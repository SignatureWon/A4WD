...
<PageTitle title="State - Travel Routes" path={data.path} data={data.data} id={data.id} />
<Form id={data.id} path={data.path}>
  <FormSection title="Info">
    <InputText name="name" label="Name" bind:value={data.data.name} required={true} />
    <InputRichText name="description" label="Description" bind:value={data.data.description} />
  </FormSection>
