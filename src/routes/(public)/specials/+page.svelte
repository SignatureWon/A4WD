<script>
  ...
  import Special from "$lib/components/public/archive/card/Special.svelte";

  export let data;
</script>

<svelte:head>
  <title>Specials - Australia 4 Wheel Drive Rentals</title>
  <meta name="description" content={`${data.pageTitle.name}. ${data.pageTitle.subtitle}`} />
  <meta property="og:title" content="Specials - {data.site.title}" />
  ...
  <link rel="canonical" href="https://australia4wdrentals.com/specials" />
  {@html `<script type="application/ld+json" class="schemantra">
  {
    "@context": "https://schema.org",
    "@type": "TravelAgency",
    "@id": "TravelAgency",
    "url": "https://australia4wdrentals.com/specials",
