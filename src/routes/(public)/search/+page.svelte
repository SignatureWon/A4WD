...
{#each Array(10) as _}
  <div class="grid grid-cols-1 md:grid-cols-2 bg-white p-2 mb-4 gap-10">
    <div>
      ...
      />
      <div class="px-4 mt-2">
        <!-- <p>The compact Adventure Camper is perfect for those interested in a real outback adventure. Roomier, more fuel capacity and cooking facilities make this 4WD campervan ideal for thrill seeking couples.</p> -->
