          ...
          <TabContent>
            <div class="p-4">
              ...
              {#if t.summary}
                ...
                <a
                  href="{env.PUBLIC_URL}/storage/v1/object/public/terms/{t.summary}"
                  target="_blank"
                  rel="noreferrer"
          ...
          <TabContent>
            <div class="p-4">
              ...
              {#if t.confirmation}
                ...
                <!-- svelte-ignore a11y-missing-content -->
                <a
                  href="{env.PUBLIC_URL}/storage/v1/object/public/terms/{t.confirmation}"
                  target="_blank"
                  rel="noreferrer"
                  class="file-icon file-icon-xl"
          ...
          <TabContent>
            <div class="p-4">
              ...
              {#if t.counter}
                ...
                <!-- svelte-ignore a11y-missing-content -->
                <a
                  href="{env.PUBLIC_URL}/storage/v1/object/public/terms/{t.counter}"
                  target="_blank"
                  rel="noreferrer"
                  class="file-icon file-icon-xl"
