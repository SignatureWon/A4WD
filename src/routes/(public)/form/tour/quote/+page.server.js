...
export const actions = {
  default: async ({ request, url, locals }) => {
    ...
    let emailBody = `
        ...
        >
        <div style="font-size: 20px; font-weight: bold">Tour Quotation Request</div>
        <table
        width="600"
        cellpadding="10"
        cellspacing="0"
    ...
    let emailSubject = `Manual Tour Quote: ${fd.pickup_date.format("DD MMM YYYY")} - ${fd.dropoff_date.format(
      "DD MMM YYYY"
...
*/
    throw redirect(303, `/form/tour/quote/success`);
  },
};
